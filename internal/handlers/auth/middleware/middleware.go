// Package middleware contains auth middleware
package middleware
...
func ParseToken(c *gin.Context, cfg *config.Config) (t *jwt.Token, err error) {
	var token string
...
func ParseAPIKey(c *gin.Context, cfg *config.Config) (apiKey string, err error) {
